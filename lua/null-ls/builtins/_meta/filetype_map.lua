...
return {
    ...
    markdown = {
        ...
        diagnostics = { "alex", "ltrs", "ltrs", "markdownlint", "markdownlint_cli2", "mdl", "proselint", "textidote",
            "textlint", "vale", "write_good" },
    ...
    python = {
        ...
        formatting = { "autopep8", "black", "blackd", "isort", "isortd", "pyink", "usort", "yapf" }
    },
    qml = {
        diagnostics = { "qmllint" },
